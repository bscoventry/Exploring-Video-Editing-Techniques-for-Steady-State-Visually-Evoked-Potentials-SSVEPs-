...
#Scripts are broken into two: First run CleanData, then run AnalyzeData
#------------------------------------------------------------------------------------------------------------
...
#Add a random seed for autoreject. Autoreject uses RNG, seeds will allow this to reproduce exactly.
seed = 777
ar = AutoReject(random_state=seed,n_jobs=4)

data = []
# Random seed to enable replication of AR random state.
...
#gdf_directory = 'C:\DataRepos\SSVEP'
...
#save_path = 'C:\DataRepos\SSVEP\cleaned-epo.fif'
